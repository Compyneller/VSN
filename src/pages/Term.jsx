      ...
      <Card className="contactUsCard shadow-sm">
        ...
        <Card.Body>
          <p>
            ...
            to the VSN Solutions Terms & Conditions.
          </p>
          <ol>
            <h5>
              <li>What do VSN Solutions do?</li>
            </h5>
            <p>
              VSN Solutions is a platform to allow users, subject to compliance
              with VSN Solutions’s policies, to sell/repair certain goods. VSN
              Solutions may not be directly involved in the transaction between
              user(s) and third party professional(s), ensuring no control by
              reasons whatsoever in any aspect of your transactions with Third
            ...
            <p>
              ...
              these Terms & Conditions, any modification, reproduction,
              redistribution, republication, uploading, posting, transmitting,
              distributing or otherwise exploiting in any way the VSN Sell
              Solution Property, or any portion of the VSN Solutions Property,
              is strictly prohibited without the prior written permission of us.
              You agree that you will comply with all applicable laws,
              regulations relating to the Site and Services, the VSN Solutions
            ...
            <h5>
              <li> VSN Solutions Copyright and trademarks.</li>
            </h5>
            <p>
            ...
            <p>
              ...
              to VSN Solutions’s Services. VSN Solutions presents information
              from Third Parties through the VSN Solutions Site and Services,
              including prices offered for your items, item descriptions,
              certain Third Party terms of service, and other information
              (“Third Party Information”). VSN Solutions cannot control, and is
              not responsible for the accuracy of any Third Party Information.
              <br />
              <br />
              ...
              indicated, not with VSN Solutions. VSN Solutions cannot control
            ...
            <p>
              VSN Solutions protect the privacy of your information. Kindly
              review the VSN Solutions privacy policy, as it has important
              ...
              prohibited. You agree that you will notify VSN Solutions
              ...
              VSN Solutions found that any unauthorized access may occur or has
              occurred, VSN Solutions may delete access without prior notice to
              you. You also agree that VSN Solutions is permitted to act upon
              any instructions received such instructions as authorized by you.
            </p>
            <h5>
            ...
            <p>
              User agrees to indemnify and hold VSN Solutions, our affiliates,
            ...
            <p>
              By submitting any VSN Solutions contact form, you understand that
              you may be contacted by a VSN Solutions representative or a
              representative from the partner you’ve chosen. You may be
              contacted via telephone, email, text, or prerecorded message
              regarding VSN Solutions programs, offers, events, announcements,
              and offers from VSN Solutions’s third party marketing partners. If
              you respond to any such offer, your information will be subject to
              that third party’s terms and conditions. By providing us your
              phone number, you grant VSN Solutions permission for the use of
              text messages, prerecorded voice or and/or automatic telephone
              dialing systems to contact you and/or deliver VSN Solutions
              related information, offers or announcements. You also agree that
              VSN Solutions may attempt to contact you via any telephone number
              you provide, even if it is a mobile telephone number which may
              result in charges to you. You can opt out from VSN Solutions email
              and messaging services at any time by writing to info@VSN
              Solutions.in .
            </p>
          </ol>
          <br />
